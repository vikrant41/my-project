        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-yellow-100 hover:text-white transition-colors">Mobile Number Consultation</a>
              </li>
              <li>
                <a href="#" className="text-yellow-100 hover:text-white transition-colors">Loshu Grid Analysis</a>
              </li>
              <li>
                <a href="#" className="text-yellow-100 hover:text-white transition-colors">Name Fixing</a>
              </li>
              <li>
                <a href="#" className="text-yellow-100 hover:text-white transition-colors">Personal Consultation</a>
              </li>
              <li>
                <a href="#" className="text-yellow-100 hover:text-white transition-colors">Business Consultation</a>
              </li>
              <li>
                <a href="#" className="text-yellow-100 hover:text-white transition-colors">Company Name Fixing</a>
              </li>
              <li>
                <a href="#" className="text-yellow-100 hover:text-white transition-colors">Crystals Reading</a>
              </li>
              <li>
                <a href="#" className="text-yellow-100 hover:text-white transition-colors">Tarot Reading</a>
              </li>
            </ul>
          </div>
